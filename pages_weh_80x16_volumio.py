...
WIDGETS = {
	...
	'elapsed_simple': { 'type':'text', 'format':'{0}/{1}', 'variables':['elapsed_simple','length|strftime+%M:%S'], 'font':'small', 'just':'left', 'varwidth':True },
...
CANVASES = {
	'volumio': { 'widgets': [ ('artisttitle',0,0), ('elapsed_simple',0,8), ('filetype',60,10),], 'size':(80,16) },	
	#'volumio_quality': { 'widgets': [ ('artisttitle',0,0), ('samplerate_tiny',0,8), ('bitdepth_tiny',50,8) ], 'size':(80,16) },
	'volumio_info': { 'widgets': [ ('quality',0,0) ] , 'size':(80,16) },
	'volumio_stream': { 'widgets': [ ('artisttitle',0,0), ('elapsed_simple',0,8), ('fixed_stream',30,8), ('total_time',55,8)], 'size':(80,16) },
...
SEQUENCES = [
	...
	#},
	{
        ...
        {   		
                ...
                'conditional': "db['state']=='pause'"
        },
	{
		'name':'seqVolume',
		'coordinates':(0,0),
		'canvases': [ { 'name':'volume_changed', 'duration':4 } ],
